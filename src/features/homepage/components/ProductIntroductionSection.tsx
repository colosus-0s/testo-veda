        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <span className="text-xs text-amber-800 font-semibold uppercase tracking-wider bg-amber-50 border border-amber-200 px-3 py-1.5 rounded-md">
            ...
            <div className="pt-6 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 border-t border-[#EBE7DF]">
              <div>
                <span className="text-[10px] uppercase font-bold text-slate-500 block mb-0.5">Maximum Retail Price</span>
