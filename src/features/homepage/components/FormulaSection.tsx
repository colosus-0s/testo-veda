  ...
  return (
    ...
    >
      <Container size="narrow">
        ...
        <div className="bg-[#FCFBF8] text-[#171717] rounded-2xl p-6 sm:p-8 border-2 border-slate-900 shadow-2xl overflow-x-auto opacity-100">
          <div className="border-b-4 border-[#171717] pb-3 mb-4">
            ...
            <div className="flex justify-between text-xs text-slate-900 font-bold mt-1">
            ...
            {facts.ingredients.map((ing, i) => (
              <div key={i} className="py-2.5 flex justify-between items-baseline gap-4">
                ...
                <div className="text-right font-mono text-xs">
                  <span className="text-slate-950 font-black">{ing.amount}</span>
                </div>
              </div>
            ))}
