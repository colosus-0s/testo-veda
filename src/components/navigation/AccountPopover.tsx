  ...
  return (
    <div className="relative inline-block text-left" ref={popoverRef}>
      ...
      <button
        ...
        className="p-2 text-[#171717] hover:text-[#6A1423] transition-colors focus:outline-none flex items-center gap-1"
        aria-label="Account Options"
        aria-expanded={isOpen}
      >
        <User className="w-5 h-5" />
        {isAuthenticated && (
          <span className="hidden sm:inline text-xs font-bold text-[#171717] max-w-[80px] truncate">
            {getFirstName()}
          </span>
        )}
      </button>
          ...
          {isAuthenticated ? (
            ...
            <div className="text-left divide-y divide-[#EBE7DF]">
              ...
              <div className="p-4 bg-[#F7F4ED] flex items-center justify-between">
                ...
                <Badge variant="maroon" size="sm">
                  {user?.role === 'admin' || user?.role === 'superadmin' ? 'Admin' : 'Customer'}
                </Badge>
              </div>
              ...
              <div className="p-2 space-y-0.5 text-xs">
                {isAdmin && (
                  <Link
                    ...
                    className="flex items-center justify-between p-2.5 rounded-xl font-bold text-[#6A1423] bg-[#6A1423]/10 hover:bg-[#6A1423] hover:text-white transition-all mb-1"
                  >
            ...
            <div className="p-6 text-left space-y-4">
              ...
              <div className="pt-3 border-t border-[#EBE7DF] flex items-center justify-between text-[11px]">
                ...
                <span className="flex items-center gap-1 text-[#173C2B] font-semibold text-[10px]">
